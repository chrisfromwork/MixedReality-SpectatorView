...
namespace Microsoft.MixedReality.SpectatorView
{
    ...
    public abstract class AssetCache : ScriptableObject
    {
        ...
        /// <summary>
        /// Loads an asset cache for the provided type
        /// </summary>
        /// <typeparam name="TAssetCache">Loads an asset cache for the provided type</typeparam>
        /// <returns>Asset cache</returns>
        ...
        /// <summary>
        /// Returns a file name prefixed with the asset cache resource folder path
        /// </summary>
        /// <param name="assetName">file name</param>
        /// <param name="assetExtension">file extension</param>
        /// <returns></returns>
        ...
        protected static string GetAssetCachesContentPath(string assetName, string assetExtension)
        {
            return $"Assets/{assetCacheDirectory}/Resources/{assetsFolderName}/{assetName}{assetExtension}";
        }

        /// <summary>
        /// When in the Unity Editor, this function creates the necessary directories for storing AssetCaches
        /// </summary>
        ...
        /// <summary>
        /// Gets or creates an AssetCache for the provided tye
        /// </summary>
        /// <typeparam name="TAssetCache">AssetCache type</typeparam>
        /// <returns>A loaded or created AssetCache for the provided type</returns>
        ...
        /// <summary>
        /// When in the Unity Editor, this function enumerates all components in scenes and prefabs for the project
        /// </summary>
        /// <typeparam name="T">Type of component to find</typeparam>
        /// <returns>An enumeration of all components found for the provided type</returns>
    ...
    public abstract class AssetCache<TAsset> : AssetCache, IAssetCache
...
#pragma warning restore 414
        ...
        /// <summary>
        /// Returns a Unity Asset for the provided AssetId
        /// </summary>
        /// <param name="assetId">Unity asset id</param>
        /// <returns>Returns the desired Unity asset if it is found, otherwise returns a default for the provided type</returns>
        ...
        /// <summary>
        /// Returns an asset id for the provided asset
        /// </summary>
        /// <param name="asset">Unity asset</param>
        /// <returns>Asset id for the provided Unity asset</returns>
        ...
        /// <summary>
        /// When called in the Unity Editor, clears all asset caches
        /// </summary>
        ...
        /// <summary>
        /// When called in the Unity Editor, updates all asset caches
        /// </summary>
        ...
        /// <summary>
        /// When called in the Unity Editor, saves all discovered assets. If no assets have been found, a search is performed.
        /// </summary>
